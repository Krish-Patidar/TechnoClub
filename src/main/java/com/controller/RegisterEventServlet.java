...
public class RegisterEventServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            // Trim the input to remove spaces before parsing
            String eventIdStr = request.getParameter("event_id").trim();
            ...
            e.printStackTrace();
            response.getWriter().write("Invalid event ID. Please enter a valid number.");
        }
    }
}
